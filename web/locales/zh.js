...
window.LOCALE_ZH = {
  ...
  'settings.scan.browse_large': '📂 浏览文件夹…',
  'sidebar.add_dir.tooltip': '添加文件夹',
  'breadcrumb.drag_preview': '📋 拖入预览（未保存）',
  'toast.drag.no_html': '请拖入 HTML 或 Markdown 文件',
  'toast.drag.loaded': '已加载',
  'toast.drag.failed': '文件读取失败',
  'welcome.subtitle_new': '👇 拖入 HTML / Markdown 文件预览，或点侧边栏 ＋ 添加文件夹',
  'welcome.add_folder': '📂 添加文件夹',
  'preview.temporary': '📋 临时预览 · 此文件未纳入管理，编辑不会保存',
